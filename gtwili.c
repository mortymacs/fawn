...
create_window(char *title, int width, int height, GtkWidget *header,
	      bool enable_scrolling, char *icon_path, bool is_parent)
{
  GtkWidget *window;
  void *tmp = NULL;
...
/* Create Input widget */
GtkWidget *
create_input(char *placeholder, char *value, bool is_multiline,
	     int max_length, char *name, int width, int height)
{
  GtkWidget *entry;
